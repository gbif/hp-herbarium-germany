...
[Listenansicht](/de/data?view=TABLE){: .button .is-primary} [Zoombare Karte](/de/data?view=MAP){: .button .is-primary} [Bilder durchstöbern](/de/data?view=GALLERY){: .button .is-primary}
{: .has-text-centered}
